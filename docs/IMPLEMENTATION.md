...
| Local Python | 3.13 via `uv` in `atlas_v1/.venv` (system Python is EOL 3.9) | Torch never runs locally — GPU work happens inside Modal images with their own Python |
