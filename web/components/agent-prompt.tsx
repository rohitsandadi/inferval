...
export function agentPrompt(repo: RepoInfo): string {
  return `You have the Atlas MCP server. Before opening a PR on ${repo.name}, verify your change:
...
4. Quote the Atlas verdict table in your PR body instead of a speed claim.
